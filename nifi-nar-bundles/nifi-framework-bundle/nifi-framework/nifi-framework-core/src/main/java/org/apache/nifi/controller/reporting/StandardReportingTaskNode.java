...
public class StandardReportingTaskNode extends AbstractReportingTaskNode implements ReportingTaskNode {
    ...
    public ReportingContext getReportingContext() {
        return new StandardReportingContext(flowController, flowController.getBulletinRepository(), getEffectivePropertyValues(), getReportingTask(), getVariableRegistry());
    }
