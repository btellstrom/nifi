...
public class StandardValidationContext implements ValidationContext {
    ...
    public PropertyValue getProperty(final PropertyDescriptor property) {
        ...
        return new StandardPropertyValue(effectiveValue, controllerServiceProvider, preparedQueries.get(property), variableRegistry);
    }
    ...
    public Collection<String> getReferencedParameters(final String propertyName) {
        ...
        final ParameterReferences references = configuration.getParameterReferences();
        final List<String> parameterNames = new ArrayList<>();
        for (final ParameterReference reference : references) {
            final Optional<String> parameterName = reference.getParameterName();
            parameterName.ifPresent(parameterNames::add);
        }
    ...
    public boolean isParameterDefined(final String parameterName) {
        ...
        return parameterContext.getParameter(parameterName) != null;
    }
