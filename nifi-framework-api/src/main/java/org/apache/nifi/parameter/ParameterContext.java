...
public interface ParameterContext extends Authorizable {
     ...
     */
    void verifyCanSetParameter(Set<Parameter> parameters);

    /**
     * Returns the Parameter with the given name
     *
     * @param parameterName the name of the parameter
     * @return the Parameter with the given name, or <code>null</code> if no parameter exists with the given name
     */
     ...
     */
    Parameter getParameter(ParameterDescriptor parameterDescriptor);
